...
from widgets import get_text_box,get_groupbox,get_volume,get_battery,get_window_name,get_spacer,get_clock,get_image
        ...
        top=bar.Bar(
            [
                ...
                *set_groupbox(group_widgets2),
                ...
                get_clock(format="%I:%M %p",foreground="9dced3",background="#282738",font="Martian Mono Nerd Font Bold"),
    ...
    Screen(
        top=bar.Bar( #pantalla principal
           [   
                ...
                get_volume(color1,color2,"Martian Mono Nerd Font Bold"," ","  {volume}%"),
